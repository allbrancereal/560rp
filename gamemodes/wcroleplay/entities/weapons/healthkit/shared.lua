...
SWEP.Purpose = "Heal people to their desire."
...
function SWEP:PrimaryAttack()	
	...
	local _qT = self:getFlag("questTable", nil );
	
	if _qT && _qT[6] then
		self.Owner:AdvanceQuestStep()
	end
	...
	if EyeTrace.Entity.Crippled then
		...
		EyeTrace.Entity:SetWalkSpeed(WALK_SPEED);
		EyeTrace.Entity:SetRunSpeed(RUN_SPEED);
	end
