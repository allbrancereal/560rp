...
function EFFECT:Init( data )
	...
	local maxparticles1 = math.ceil(jetlength/41) + 1
	...
	local emitter = ParticleEmitter( Pos )
		...
		for i=1, maxparticles1 do
			...
			local particle = emitter:Add( "effects/splash1", Pos + Velocity * i * math.Rand(1.6,3) )
		...
		--		particle:SetEndSize( math.Rand( 72, 96 ) )
				particle:SetEndSize( math.Rand( 16, 26 ) )
		...
		-- for i=0, maxparticles2 do
			...
			-- local particle = emitter:Add( "particles/smokey", Pos + Velocity * i * math.Rand(0.3,0.6))
