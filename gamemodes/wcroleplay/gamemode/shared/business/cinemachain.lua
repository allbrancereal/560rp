...
Business.Name = 				"Cinema Chain";

Business.Description = 		"A lucrative Business";

Business.Shares = 				fsrp.config.MaxCinemaShares;
...
Business.CanBuy = function( _p , amt )
				if !_p:NearNPC( "bu_cinemachain") then return false end
...
if SERVER then
	...
	net.Receive( "buycinemachainMarketShare" , function ( len , _p )

		loadBusinesses( _p )
		_p:buyStock( 3, net.ReadInt(5) );	
