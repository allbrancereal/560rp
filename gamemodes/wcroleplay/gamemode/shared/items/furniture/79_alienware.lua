...
ITEM.Name = "Alienware Aurora R5"
ITEM.Quality = 0
ITEM.Description = "Old but gold, many claim the R6 looks less Gamery."
ITEM.Model	= "models/gaming-models/nebukadnezar/environment/indoors/alien_pc.mdl"
ITEM.Weight = 0.5;
ITEM.MaxStack = 5;
ITEM.Cost = 3349;
ITEM.Class = "fsrpcomputer";
...
ITEM.CanUse = function( _p )
	return !_p:getFlag( "computerStatus", false )
end

ITEM.EntityOnUse = function( _p, _e )
	
	_p:setFlag( "computerEntityIndex" , _e:EntIndex( ) );
	_p:setFlag( "computerStatus", true )
	_e:SetSpecifications( _p:GetRPComputer() )
	_e:setFlag("itemID", 79)
