...
net.Receive("fsrp.notify", function ( len, _p )

		AddNotify(net.ReadString(), NOTIFY_GENERIC, 10, false);
...
local function DrawNotice( self, k, v, i )
	...
	v.velx = v.velx * (0.95 - RealFrameTime() * 4 )
	v.vely = v.vely * (0.95 - RealFrameTime() * 4 )
