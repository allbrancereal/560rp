...
// PUT THIS IN GARRYSMOD/GARRYSMOD/LUA/AUTORUN
...
local function showItemView ( Player )
	...
	DEV_VCO_Panel:SetTitle('Developer Tool - Vector Coordinator');
	...
	function OuputVectors:DoClick ( )
		stringSentence = "ITEM.CamPos = Vector(".. math.Round( DEV_VCO_CAMPOS_X, 2) .. ", " ..math.Round( DEV_VCO_CAMPOS_Y,2) .. ", " .. math.Round(DEV_VCO_CAMPOS_Z,2) .. ");\nITEM.LookAt = Vector(" .. math.Round(DEV_VCO_LOOKAT_X,2) .. ", " .. math.Round(DEV_VCO_LOOKAT_Y,2) .. ", " .. math.Round(DEV_VCO_LOOKAT_Z,2) .. ");";
		SetClipboardText( stringSentence );
	end
...
concommand.Add("item_view", showItemView);
