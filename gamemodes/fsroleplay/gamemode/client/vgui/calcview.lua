...
fsrp.devprint("[560Roleplay] - Fetching CVCD" )
...
local function showItemView ( Player )
	...
	function OuputVectors:DoClick ( )
		stringSentence = "modelcampos = Vector(".. DEV_VCO_CAMPOS_X .. ", " .. DEV_VCO_CAMPOS_Y .. ", " .. DEV_VCO_CAMPOS_Z .. "),\nmodellookat = Vector(" .. DEV_VCO_LOOKAT_X .. ", " .. DEV_VCO_LOOKAT_Y .. ", " .. DEV_VCO_LOOKAT_Z .. "),";
...
fsrp.devprint("[560Roleplay] - Copy That, We got it. (Accquired CVCD)" )
