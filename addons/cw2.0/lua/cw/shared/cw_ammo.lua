...
CustomizableWeaponry:registerAmmo("sniper", "Sniper Rounds", 12.7, 51)
CustomizableWeaponry:registerAmmo("rifle", "Rifle Rounds", 7.62, 39)
CustomizableWeaponry:registerAmmo("submachine", "Submachine Rounds", 5.56, 45)
CustomizableWeaponry:registerAmmo("pistol", "Pistol Rounds", 11.5, 32.6)
