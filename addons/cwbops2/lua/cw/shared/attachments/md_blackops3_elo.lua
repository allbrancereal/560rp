local att = {}
att.name = "md_blackops3_elo"
att.displayName = "ELO"
att.displayNameShort = "ELO"
att.aimPos = {"BO3_ELOPos", "BO3_ELOAng"}
att.FOVModifier = 15
att.isSight = true
att.colorType = CustomizableWeaponry.colorableParts.COLOR_TYPE_SIGHT

if CLIENT then
	att.displayIcon = surface.GetTextureID("blackops3/icon_atts/cac_mods_red_dot")
	att.description = {
	[1] = {t = "Emitted Light Optic.", c = CustomizableWeaponry.textColors.POSITIVE},
	[2] = {t = "Iron sights with a floating point illuminated reticle.", c = CustomizableWeaponry.textColors.POSITIVE},
	[3] = {t = "1.5X ZOOM.", c = CustomizableWeaponry.textColors.POSITIVE}
	}
	
	att.reticle = "blackops3/reticles/reflex_4"
	att._reticleSize = 15
	...
	function att:elementRender()
		...
		local model_stencil = "models/loyalists/blackops3/public/optic_laser_stencil.mdl"
		local model_att = "models/loyalists/blackops3/public/optic_laser.mdl"
	...
	-- function att:drawReticle()
		...
		-- diff = self:getDifferenceToAimPos(self.BO3_ELOPos, self.BO3_ELOAng, 1)
