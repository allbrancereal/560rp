local att = {}
att.name = "md_blackops3_acog"
att.displayName = "Recon Sight"
att.displayNameShort = "Recon"
att.aimPos = {"BO3_ACOGPos", "BO3_ACOGAng"}
att.FOVModifier = 30
att.isSight = true
att.colorType = CustomizableWeaponry.colorableParts.COLOR_TYPE_SIGHT

if CLIENT then
	att.displayIcon = surface.GetTextureID("blackops3/icon_atts/cac_mods_acog")
	att.description = {
	[1] = {t = "Enhanced zoom sight.", c = CustomizableWeaponry.textColors.POSITIVE},
	[2] = {t = "3X ZOOM.", c = CustomizableWeaponry.textColors.POSITIVE}
	}
	
	att.reticle = "blackops3/reticles/acog_0"
	att._reticleSize = 15
	...
	function att:elementRender()
		...
		local model_stencil = "models/loyalists/blackops3/public/optic_acog_stencil.mdl"
		local model_att = "models/loyalists/blackops3/public/optic_acog.mdl"
