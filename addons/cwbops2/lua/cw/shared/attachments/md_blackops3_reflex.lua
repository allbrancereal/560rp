local att = {}
att.name = "md_blackops3_reflex"
att.displayName = "Reflex Sight"
att.displayNameShort = "Reflex"
att.aimPos = {"BO3_ReflexPos", "BO3_ReflexAng"}
att.FOVModifier = 15
att.isSight = true
att.colorType = CustomizableWeaponry.colorableParts.COLOR_TYPE_SIGHT

if CLIENT then
	att.displayIcon = surface.GetTextureID("blackops3/icon_atts/cac_mods_reflex")
	att.description = {
	...
	att.reticle = "blackops3/reticles/i_t7_attach_optic_reflex_reticle_c"
	att._reticleSize = 20
	...
	function att:elementRender()
		...
		local model_stencil = "models/loyalists/blackops3/public/optic_reflex_stencil.mdl"
		local model_att = "models/loyalists/blackops3/public/optic_reflex.mdl"
