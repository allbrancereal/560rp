...
NPC.model = "models/mailer/character/human/female/humanfemale_anim.mdl"
...
util.AddNetworkString("sendClientToEvo")
function NPC:onjoinEvo(entity)
	entity:AddTag("JoinedFromOtherServer")
	timer.Simple(3,function()
		//net.Start("sendClientToEvo")
		//net.Send(entity)
	end)
